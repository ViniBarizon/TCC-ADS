...
function Toolbar() {
    ...
    return(
        <div>
          <nav id="toolbarNav" className={scrollPosition > 0 ? 
          "fixed top-0 z-50 w-full bg-white shadow dark:bg-gray-800 ease-in-out duration-200" :
          "w-full fixed top-0 z-50 white shadow border-gray-200 bg-emerald-100 ease-in-out duration-200"}>
